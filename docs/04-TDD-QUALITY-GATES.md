...
- Core numerical and ordering rules must be covered by direct tests.
...
- Deterministic ordering, rounding, and boundary-touching policies must be asserted in tests, not merely described in docs.
- Changes to shape or query semantics require fixture and acceptance-matrix updates.
